...
def download(url, aweme_id, desc):
    ...
    if os.path.exists(f'DownloadSignal/{file_name}'):
    ...
    with open(f'DownloadSignal/{file_name}', "wb") as f:
...
def main(link):
    ...
    jsonStr = get_file_content("query_result.txt")
    ...
    for item in data['data']:
        all_data.append({
            ...
            "src": item['aweme_info']['author']['avatar_thumb']['uri']
        })
